...
/**
 * diva_myhelp - THis function changes the current directory of the process
 * @diva_divas_info: Represents the d_structure containing arguments. Used to maintain
 *          constant function prototype.
 *  Return: 0
 */
int diva_myhelp(info_t *diva_divas_info)
{
	char **d_arg_array;
